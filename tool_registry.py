...
TOOLS = {
    ...
    "artifact": "Generate a shareable Claude Code Artifact — interactive HTML page for diagrams, dashboards, code walkthroughs, PR reviews, data visualizations, or any team-shareable output.",
}
