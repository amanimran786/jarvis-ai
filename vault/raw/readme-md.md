...
- **Local markdown vault** — indexed markdown files in `vault/` can be searched and selectively injected into the current request before Jarvis grows prompt context or escalates outward
...
vault.py                 # Local markdown vault indexing, search, and snippet loading
