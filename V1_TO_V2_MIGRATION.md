...
| Authentication-log triage | `jarvis_v2/auth_logs.py`, `scripts/run_v2_auth_triage.py` | Adds normalized-event correlation, bounded source-line evidence, and local Qwen summaries with verified counts/citations |
